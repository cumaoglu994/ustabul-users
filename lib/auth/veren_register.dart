...
class VerenRegister extends StatefulWidget {
  @override
  State<VerenRegister> createState() => _VerenRegister();
}

class _VerenRegister extends State<VerenRegister> {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
                'assets/images/veren_background.jpg'), // Arka plan resmi buraya
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      _signUpUsers();
                      AuthController.hizmetTuru = "Hizmet Veren";
                    },
                    child: Container(

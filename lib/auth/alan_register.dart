...
class AlanRegister extends StatefulWidget {
  @override
  State<AlanRegister> createState() => _AlanRegister();
}

class _AlanRegister extends State<AlanRegister> {
  ...
  _signUpUsers() async {
    ...
    if (_formkey.currentState!.validate()) {
      ...
      return showSnakBar(context, 'Hesabınız oluşturuldu');
    } else {
      setState(() {
        _isloading = false;
      });
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      _signUpUsers();
                      AuthController.hizmetTuru = "Hizmet Alan";
                    },
                    child: Container(
